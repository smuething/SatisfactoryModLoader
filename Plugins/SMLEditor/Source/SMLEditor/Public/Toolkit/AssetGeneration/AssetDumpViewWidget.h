...
class SMLEDITOR_API SAssetDumpViewWidget : public SCompoundWidget {
public:
...
class SMLEDITOR_API SAssetDumpTreeNodeRow : public SMultiColumnTableRow<TSharedPtr<FAssetDumpTreeNode>> {
