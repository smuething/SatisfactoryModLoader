...
struct SMLEDITOR_API FAssetGeneratorConfiguration {
public:
 ...
 */
class SMLEDITOR_API FAssetGenerationProcessor : public FTickableGameObject, public TSharedFromThis<FAssetGenerationProcessor> {
private:
